# Generated by Django 3.2.5 on 2021-09-01 13:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consultant', models.ForeignKey(blank=True, limit_choices_to={'depart__title': '销售部'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='consultant', to='crm.userinfo', verbose_name='项目顾问')),
                ('course', models.ManyToManyField(to='crm.Project', verbose_name='咨询项目')),
                ('referral_from', models.ForeignKey(blank=True, help_text='若此客户是转介绍自内部人员,请在此处选择内部人员姓名', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='internal_referral', to='crm.customer', verbose_name='转介绍自客户')),
            ],
        ),
    ]
